...
public class StockedFoodController {
	...
	private final List<StockedFood> stockedFoods = List.of(
			new StockedFood(CUP_RAMEN_UUID, "カップラーメン", BigDecimal.valueOf(150), LocalDate.of(2023, 12, 23),
					LocalDate.of(2025, 12, 1), true, ""),
			new StockedFood(RICE_UUID, "お米", BigDecimal.valueOf(5_000), LocalDate.of(2023, 12, 13),
					LocalDate.of(2024, 7, 1), false, "10kg"),
			new StockedFood(CANNED_MACKEREL_UUID, "鯖缶", BigDecimal.valueOf(250), LocalDate.of(2023, 12, 20),
	...
	public ResponseEntity<List<StockedFood>> getStockedFoods() {
		return ResponseEntity.ok(this.stockedFoods);
	}
